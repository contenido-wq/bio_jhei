...
def main():
    ...
    # El hero ya no lleva retrato vertical sino un banner apaisado
    # (assets/img/jhei-hero.jpg), y no se genera desde aquí. La función
    # portrait() se conserva por si hace falta volver a un placeholder.
