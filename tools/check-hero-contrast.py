...
# mucho más arriba.
#
# 210 no es una estimación: se midió en el navegador a 320, 360, 390 y 430, y
# en los cuatro dio entre 197 y 200px — el bloque apenas cambia de alto porque
# la frase cabe en una línea en todos. Los 10px de más son el margen.
#
